...
class FundRepository @Inject constructor(
    ...
    suspend fun getIndexKline(secId: String, klt: Int = 101, lmt: Int = 120): IndexKlineResponse? { return try { fundApi.getIndexKline(secId = secId, klt = klt, lmt = lmt) } catch (e: Exception) { null } }
